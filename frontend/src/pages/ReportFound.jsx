  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[#1F2937]">Report Found Item</h1>
          <p className="text-[#6B7280]">Help reunite lost items with their owners.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <label className="block text-sm font-medium text-[#1F2937]">Date Found</label>
            <input
              type="date"
              required
              value={form.date}
        ...
        <div>
          <label className="block text-sm font-medium text-[#1F2937]">Location Found</label>
          <input
            type="text"
            required
            value={form.location}
        ...
        <button type="submit" disabled={loading} className="w-full rounded-full bg-green-500 py-3 font-semibold text-white hover:bg-green-600 disabled:opacity-60">
